...
cluster_results_analysis <- function(combo_pass, analyze_this_many, 
                                     Timesteps_pass) {
  ...
  colnames(data.result) <- c("File_path", "replicate", "combo",
                             "speciation_1", "speciation_2",
                             "speciation_3", "speciation_4",
                             "extinction_1", "extinction_2",
                             "extinction_3", "extinction_4",
                             "diffusion_1", "diffusion_2",
                             "diffusion_3", "diffusion_4",
                             "takeover_1", "takeover_2", 
                             "takeover_3", "takeover_4",
                             "arisal_1", "Timesteps")
...
plot(0,0, type="n", xlim=c(0,8), ylim=c(0,300), xlab="log(number of tips)",
