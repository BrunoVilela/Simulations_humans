...
~/Box Sync/colliding ranges/Simulations_humans/Concatenated data tables
save(Concatenated_data, file="~/Box Sync/colliding ranges/Simulations_humans/BANTU_Four_model_compare_background_TO_and_not.Rdata")
