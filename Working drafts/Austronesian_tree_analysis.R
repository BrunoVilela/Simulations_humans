...
# Real Bantu tree
load("~/Box Sync/Bruno/WUSTL projects/Simulations_humans/Available trees/Tree_austronisian.RData")

# Match
match.aust <- match(aus_tree$tip.label, 
                    Society_data_with_binary_conversions$Society.id)
mydata <- Society_data_with_binary_conversions[match.aust, ]
...
mytree <- drop.tip(aus_tree, remove)
