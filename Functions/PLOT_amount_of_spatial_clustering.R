...
##################################################################################
SpatialClumping <- function(which_model1, which_model2, which_model3, which_model4 ){
		
		
InternalSpatialClumping <- function(which_model1, which_model2, which_model3, which_model4){	
	colors <-  c("cornflowerblue", "firebrick", "darkgreen", "orange")
	
	data.result_sub_1 <- unlist(which_model1[[8]])
	data.result_sub_2 <- unlist(which_model2[[8]])
	data.result_sub_3 <- unlist(which_model3[[8]])
	data.result_sub_4 <- unlist(which_model4[[8]])
...
InternalSpatialClumping(which_model1, which_model2, which_model3, which_model4)
