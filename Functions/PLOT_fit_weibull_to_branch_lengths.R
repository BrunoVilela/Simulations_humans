...
FarmWeibullPlots <- function(which_model1, which_model2, which_model3, which_model4 ){
	...
	points(jitter(rep(1, length(data.result_sub_1)),7), data.result_sub_1, col=adjustcolor(colors[1], alpha=.5))
	points(jitter(rep(2, length(data.result_sub_2)),5), data.result_sub_2, col=adjustcolor(colors[2], alpha=.5))
	points(jitter(rep(3, length(data.result_sub_3)),4), data.result_sub_3, col=adjustcolor(colors[3], alpha=.5))
	points(jitter(rep(4, length(data.result_sub_4)),2), data.result_sub_4, col=adjustcolor(colors[4], alpha=.5))
